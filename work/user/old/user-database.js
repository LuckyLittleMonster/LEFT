...
class UserMiddleware {
   ...
   *  DocFinder.
   */
  static async connectDatabase(dbUrl, dbName, userCollectionName) {
    const client = await mongo.connect(dbUrl, MONGO_OPTIONS);
    const finder = new UserMiddleware(mongoUrl, dbName, client);
